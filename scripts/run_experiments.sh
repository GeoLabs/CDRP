...
ds_path="/home/geosys/sarunet/landslide-sar-unet/scripts/hokkaido_japan.zarr" # Path to the dataset downloaded from zenodo (see README.md)

 for timestep_length in {1..3..1}
 do
